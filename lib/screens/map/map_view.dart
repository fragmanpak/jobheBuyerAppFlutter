...
import 'package:jobheebuyer/ui/custom_window_info.dart';
import 'package:jobheebuyer/ui/my_text_field.dart';
                      ...
                      return GoogleMap(
                        ...
                        onMapCreated: (GoogleMapController controller) {
                          setState(() {
                            ...
                            MapService.instance.controller.googleMapController =
                                controller;
                          });
                        ...
                        polylines: {
                          if (state is LoadedRoutes)
                            if (state.endAddress.polyline != [])
                              Polyline(
                                polylineId:
                                const PolylineId('overview_polyline'),
                                color: CityTheme.cityBlack,
                                width: 5,
                                points: state.endAddress.polyline
                              ...
                              Row(
                                children: [
                                  Column(
                                    children: [
                                      Icon(Icons.circle,
                                          size: 16, color: CityTheme.cityblue),
                                      Container(
                                          width: 4,
                                          height: 40,
